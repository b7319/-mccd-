...
# 判断均线是否接近形成密集
def is_moving_averages_cluster(df, tolerance=0.1):
    ma34 = df['ma34'].iloc[-1]
    ma170 = df['ma170'].iloc[-1]
    ma453 = df['ma453'].iloc[-1]
    return abs(ma34 - ma170) < tolerance and abs(ma170 - ma453) < tolerance
...
def main():
    ...
    while True:
        for idx, symbol in enumerate(symbols):
            ...
            df = fetch_data(symbol, '5m', since=since_3h)
